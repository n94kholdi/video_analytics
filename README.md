...
`All_weights/Weights_final/Tracking_osnet_x0_25_msmt17.onnx`. CI downloads them
from the `VIDEO_ANALYTICS_WEIGHTS_URL` repository secret when they are not in
the checkout.
