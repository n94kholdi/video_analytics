...
def test_factory_initializes_registered_trackers() -> None:
    ...
    assert catalog == {"bytetrack", "stabletrack", "deepocsort", "botsort", "ucmctrack"}
...
@pytest.mark.parametrize("tracker_type", ["bytetrack", "stabletrack", "deepocsort", "botsort", "ucmctrack"])
